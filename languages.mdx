...
icon: globe
description: "Automatic language detection and culture-aware safety analysis in 14 languages"
keywords: [language detection, multilingual, i18n, localization, auto-detect]
---

Tuteliq detects and analyzes content in 14 languages. Language is auto-detected — no configuration required.
...
```json
{
  "error": {
    "code": "ANALYSIS_6009",
    "message": "Detected language \"Chinese\" is not supported. Supported languages: en, es, pt, uk, sv, no, da, fi, de, fr, nl, pl, it, tr."
  }
}
```
