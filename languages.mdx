...
icon: globe
description: "Automatic language detection and culture-aware safety analysis in 32 languages"
keywords: [language detection, multilingual, i18n, localization, auto-detect]
---

Tuteliq detects and analyzes content in 32 languages. Language is auto-detected — no configuration required.
