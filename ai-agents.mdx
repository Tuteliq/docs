...
For AI assistants that support the [Model Context Protocol](/mcp) (Claude Desktop, Cursor, Windsurf), Tuteliq exposes all detection tools as MCP tools — no code required.
...
See the [MCP setup guide](/mcp) for configuration instructions.
