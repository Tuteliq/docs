...
Document analysis uses **per-page, per-endpoint pricing**. Each page-endpoint combination costs 1 credit (matching text detection), with a minimum of 3 credits to cover extraction overhead. See [Document Analysis](/document-analysis#credit-pricing) for detailed examples.
