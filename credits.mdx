...
| `verifyAge` (full) | 20 | Document analysis + liveness + biometric estimation (Assure and above) |
| `verifyIdentity` | 25 | Document verification + liveness + face matching (Assure and above) |
...
<CodeGroup>
  ...
  ```
  ```bash cURL
  curl https://api.tuteliq.ai/api/v1/usage/summary \
