...
<CardGroup cols={2}>
  ...
  <Card title="Multimodal & Multilingual" icon="layer-group">
    Text, voice, and images analyzed through a single API in 14 languages. Language is auto-detected — no configuration needed. Audio is transcribed and safety-analyzed with timestamped segments. Images are classified visually and OCR-scanned for embedded text.
  </Card>
