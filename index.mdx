...
Tuteliq is a content moderation API built around the harm taxonomy of the Kids Online Safety Act (KOSA). Detect grooming, bullying, self-harm, fraud, social engineering, and more — with age-calibrated risk scoring designed for near-real-time moderation. Verify user age and identity to prevent impersonation and support your compliance program. One API call replaces months of in-house ML work.
...
Child safety compliance shouldn't require a machine learning team. The Kids Online Safety Act (KOSA) — pending US federal legislation — would require covered platforms to protect minors from nine categories of harm: bullying, grooming, eating disorders, substance use, self-harm, depression, compulsive usage, sexual exploitation, and unsafe visual content. Building detection for even one of these categories takes months of ML engineering, training data, and ongoing maintenance. Building for all nine, across text, voice, and images, with age-appropriate calibration? That's a team-year of work.
...
<CardGroup cols={2}>
  ...
  <Card title="Identity Verification" icon="fingerprint" href="/verification#identity-verification">
    Full identity verification with deterministic document validation, face matching, visual liveness detection, and 7-layer fraud cross-referencing.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Full KOSA Coverage" icon="shield-check">
    Every KOSA harm category covered out of the box. No mix-and-match from multiple vendors. One integration, one detection layer across the whole taxonomy.
  </Card>
  <Card title="Multimodal & Multilingual" icon="layer-group">
    Text, voice, and images analyzed through a single API in 32 languages (English stable, 31 beta). Language is auto-detected — no configuration needed. Audio is transcribed and safety-analyzed with timestamped segments. Images are classified visually and OCR-scanned for embedded text.
  </Card>
...
| Languages supported | 32 — English (stable), all 24 EU official languages + Ukrainian, Norwegian, Turkish, Chinese, Japanese, Korean, Arabic, Russian (beta) |
| Rate limits | 1,000–10,000 req/min depending on [tier](/authentication) |
