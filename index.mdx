...
Tuteliq is a content moderation API aligned with KOSA. Detect grooming, bullying, self-harm, fraud, social engineering, and more — with age-calibrated risk scoring in under 400ms. Verify user age and identity to prevent impersonation and ensure compliance. One API call replaces months of in-house ML work.
...
<CardGroup cols={2}>
  ...
  <Card title="Age Verification" icon="id-card" href="/api-reference/introduction">
    Verify user age through document analysis and biometric estimation — KOSA-aligned age assurance for platforms serving minors.
  </Card>
  <Card title="Identity Verification" icon="fingerprint" href="/api-reference/introduction">
    Confirm user identity with document verification and liveness detection — prevent impersonation and protect children from bad actors.
  </Card>
</CardGroup>
