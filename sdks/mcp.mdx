...
The Tuteliq MCP server (`@tuteliq/mcp` v3.19.0) exposes child safety detection as tools for AI assistants that support the [Model Context Protocol](https://modelcontextprotocol.io), including Claude Desktop, Claude Code, Cursor, Windsurf, and other MCP-compatible clients.
