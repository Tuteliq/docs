...
| `detect_social_engineering` | Detect social engineering tactics | `text`, `age_group` |
| `detect_app_fraud` | Detect app-based fraud patterns | `text`, `age_group` |
| `detect_romance_scam` | Detect romance scam patterns | `text`, `age_group` |
| `detect_mule_recruitment` | Detect money mule recruitment | `text`, `age_group` |
| `detect_gambling_harm` | Detect gambling harm indicators | `text`, `age_group` |
| `detect_coercive_control` | Detect coercive control patterns | `text`, `age_group` |
| `detect_vulnerability_exploitation` | Detect vulnerability exploitation | `text`, `age_group` |
| `detect_radicalisation` | Detect radicalisation indicators | `text`, `age_group` |
| `analyse_multi` | Run multiple detections on one text | `text`, `detections`, `age_group` |
| `analyze_voice` | Analyze audio files | `file_path`, `age_group` |
| `analyze_image` | Analyze image files | `file_path`, `age_group` |
| `analyze_video` | Analyze video files | `file_path`, `age_group` |
