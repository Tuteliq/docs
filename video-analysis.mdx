...
Video analysis costs **95 credits** per request, regardless of the number of frames extracted. For real-time video monitoring with per-frame billing, see [Voice & Video Streaming](/voice-streaming).
