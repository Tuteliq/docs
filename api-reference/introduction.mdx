...
| **Fraud Detection** | Financial and social fraud — social engineering, app fraud, romance scams, mule recruitment |
| **Safety Extended** | Extended safety — gambling harm, coercive control, vulnerability exploitation, radicalisation |
| **Multi-Endpoint Analysis** | Fan-out a single text to multiple detection endpoints in parallel |
...
| **Verification** | Age verification and identity verification (Beta) |
