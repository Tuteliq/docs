...
All KOSA harm categories are detected across 14 languages: English (stable), Spanish, Portuguese, Ukrainian, Swedish, Norwegian, Danish, Finnish, German, French, Dutch, Polish, Italian, and Turkish (beta). Language is auto-detected — no explicit parameter is required. Each language includes culture-specific analysis guidelines for local slang, idioms, and harmful terms, ensuring that detection quality is maintained across linguistic contexts.
