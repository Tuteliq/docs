...
| Age Verification           | `/verification/age`                              | Document-based age assurance (Beta — Assure and above) |
| Identity Verification      | `/verification/identity`                         | Document + liveness identity confirmation (Beta — Assure and above) |
