...
- [`detect_vulnerability_exploitation`](https://tuteliq.ai/docs/api-reference/vulnerability-exploitation) — full endpoint reference
- [`analyse_multi`](https://tuteliq.ai/docs/api-reference/analyse-multi) — batch multi-endpoint analysis (applies modifier internally when both fire)
- [AI agents](/ai-agents) — composing Tuteliq primitives from an agent
- [Incident logging](/incident-logging) — routing and reviewing what composition surfaces
