...
Tuteliq is built to catch what keyword filters and general-purpose classifiers miss: novel algospeak, emoji payloads, homoglyphs, and context-dependent slang that only reads as harmful given the conversation around it. Coded terms are maintained as an evolving lexicon and scored in context rather than matched against a fixed list.

<Note>
Comparative benchmark figures are being re-validated and are not published here in the meantime.
</Note>
...
Coded-language and filter-evasion handling is a platform-wide capability that applies to every detector, not just bullying. It is strongest on novel algospeak, emoji payloads, and context-dependent slang, because those depend on reading the surrounding conversation rather than matching a word list.
    ...
    __html: JSON.stringify({
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Coded-language and filter-evasion handling is a platform-wide capability that applies to every detector, not just bullying. It is strongest on novel algospeak, emoji payloads, and context-dependent slang."
          }
        },
        {
          "@type": "Question",
