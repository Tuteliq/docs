...
- **Coded slang, emoji, and evasion.** Abusive users deliberately dodge filters with leetspeak, emoji payloads, homoglyphs, and algospeak. Tuteliq maintains a lexicon of these and reads them in conversation context rather than matching a word list. See [Prescreen lexicon](/prescreen-lexicon).
...
- **32 languages** (English stable, 31 beta) with code-switching, so mixed-language lobbies are covered. See [Languages](/languages).
...
- **Coded-language resilience** against leetspeak, emoji payloads, homoglyphs and algospeak.
...
Yes. It is maintained against an evolving lexicon of coded terms, emoji, leetspeak, and algospeak, and evaluates them in the context of the surrounding conversation.
    ...
    __html: JSON.stringify({
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. It is maintained against an evolving lexicon of coded terms, emoji, leetspeak, and algospeak, and evaluates them in the context of the surrounding conversation."
          }
        },
        {
          "@type": "Question",
