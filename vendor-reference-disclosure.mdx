...
- Model card, `tuteliq/tuteliq-detect-24b-v6` on Hugging Face: full evaluation across nine suites. The model is proprietary and the repository is private, so access is granted under agreement rather than publicly readable
